class Level2 extends Phaser.Scene {
    ...
    create() {
        ...
        // Create jumpplatform layer
        this.jumpLayer = this.map.createLayer("JumpPlatforms", this.tileset1, 0, 0);
        ...
        this.jumpLayer.setCollisionByProperty({
            collides: true
        });
        ...
        this.physics.add.collider(my.sprite.player, this.jumpLayer, (obj1, obj2) => {
        ...
        document.getElementById('description').innerHTML = '<h2>Level 2! Use the jump pads to !</h2><br>Use the arrow keys to jump and move!</br>';
    ...
    update() {
        ...
        if(this.winState == true) {
            my.sprite.player.setAccelerationX(0);
            document.getElementById('description').innerHTML = '<h1>Level Complete!!!</h1><br>Press S to begin the next level!</br>';
